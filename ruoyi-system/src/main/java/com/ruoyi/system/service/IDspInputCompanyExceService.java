 ...
 * @date 2026-04-18
 */
public interface IDspInputCompanyExceService 
{
    /**
     * 查询导入流水
     * 
    ...
    String importIncomeExcel(List<DspIncome> dspIncomeList, boolean updateSupport, String operName);
}
