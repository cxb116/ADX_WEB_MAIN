...
// 查询预算数据详细报表列表
export function listDataDspSlotDetail(query) {
  return request({
...
// 查询预算数据详细报表详细
export function getDataDspSlotDetail(id) {
  return request({
...
// 新增预算数据详细报表
export function addDataDspSlotDetail(data) {
  return request({
...
// 修改预算数据详细报表
export function updateDataDspSlotDetail(data) {
  return request({
    url: '/system/dataDspSlot',
    method: 'put',
    data: data
...
// 删除预算数据详细报表
export function delDataDspSlotDetail(id) {
  return request({
    url: '/system/dataDspSlot/' + id,
    method: 'delete'
  })
